...
import 'package:clean_architecture_tdd/app/features/number_trivia/data/repositories/number_trivia_repository_imp.dart';
...
void main() {
  ...
  group('getConcreteNumberTrivia', () {
    ...
    runTestOffline(() {
      ...
      test('should return CacheFailure when there no cached data present',
          () async {
        // arrange
        when(mockLocalDataSource.getLastNumberTrivia())
